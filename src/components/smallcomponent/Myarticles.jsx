...
function Myarticles({
		...
		swaConfirm(
			...
			async () => {
				await axios
					.delete(url + "/guide", {
						data: JSON.stringify({
							main_articleno: e.target.dataset.articleno,
						}),
	...
	return (
		<div id="c-myarts" className="c-block">
										...
										<tr key={i}>
											<td>
												<a
													href="#"
													onClick={() => {
														history.push(`/view${value.articleno}`);
													}}
												>
													{value.title}
												</a>
											...
											<td>
												<i className="fa-regular fa-eye"></i> {value.view_count}
											</td>
											<td>
												<i className="fa-regular fa-heart"></i> {value.count}
											</td>
											<td>已發佈</td>
											<td>
												<a
													...
													href="#"
													onClick={() => {
														history.push(`/edit/${value.articleno}`);
													}}
												>
